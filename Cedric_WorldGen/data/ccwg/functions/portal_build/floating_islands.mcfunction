...
execute at @e[type=armor_stand,name=ccwg_portal,distance=..100] run kill @e[type=armor_stand,name=ccwg_portal_floating_islands,distance=..1]
execute at @e[type=armor_stand,name=ccwg_portal,distance=..100] run summon armor_stand ~ ~0.5 ~ {Invisible:1,Marker:1,CustomName:"\"ccwg_portal_floating_islands\"",CustomNameVisible:0}
