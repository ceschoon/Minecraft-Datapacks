...
spreadplayers ~30 ~30 0 5 false @s
...
spreadplayers ~-30 ~30 0 5 false @s
execute at @s run summon armor_stand ~ 205 ~ {Invisible:1,Marker:1,CustomName:"\"villager1\"",CustomNameVisible:0}
...
spreadplayers ~-40 ~-40 0 5 false @s
execute at @s run summon armor_stand ~ 205 ~ {Invisible:1,Marker:1,CustomName:"\"cannon1\"",CustomNameVisible:0}
...
spreadplayers ~ ~40 0 5 false @s
execute at @s run summon armor_stand ~ 202 ~ {Invisible:1,Marker:1,CustomName:"\"team4\"",CustomNameVisible:0}
