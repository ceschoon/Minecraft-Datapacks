...
execute at @s run summon armor_stand ~ 195 ~ {Invisible:1,Marker:1,CustomName:"\"emerald1\"",CustomNameVisible:0}
...
spreadplayers ~-20 ~-20 0 10 false @s
execute at @s run summon armor_stand ~ 195 ~ {Invisible:1,Marker:1,CustomName:"\"emerald2\"",CustomNameVisible:0}
...
spreadplayers ~-60 ~-20 0 10 false @s
