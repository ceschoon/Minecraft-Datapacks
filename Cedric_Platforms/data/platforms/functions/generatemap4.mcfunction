...
execute at @s run summon armor_stand ~60 205 ~30 {Invisible:1,Marker:1,CustomName:"\"emerald2\"",CustomNameVisible:0}
...
execute at @s run summon armor_stand ~-60 205 ~30 {Invisible:1,Marker:1,CustomName:"\"villager2\"",CustomNameVisible:0}
