...
spreadplayers ~-30 ~-15 0 5 false @s
execute at @s run summon armor_stand ~ 202 ~ {Invisible:1,Marker:1,CustomName:"\"emerald1\"",CustomNameVisible:0}
...
spreadplayers ~60 ~30 0 5 false @s
execute at @s run summon armor_stand ~ 205 ~ {Invisible:1,Marker:1,CustomName:"\"emerald2\"",CustomNameVisible:0}
execute at @e[type=armor_stand,name=emerald2] run function platforms:buildemerald
execute at @e[type=armor_stand,name=diamond] run tp @s ~ ~ ~

# Build villager platform 1
spreadplayers ~30 ~-15 0 5 false @s
execute at @s run summon armor_stand ~ 202 ~ {Invisible:1,Marker:1,CustomName:"\"villager1\"",CustomNameVisible:0}
...
spreadplayers ~ ~30 0 5 false @s
execute at @s run summon armor_stand ~ 202 ~ {Invisible:1,Marker:1,CustomName:"\"cannon1\"",CustomNameVisible:0}
execute at @e[type=armor_stand,name=cannon1] run function platforms:buildmagma
execute at @e[type=armor_stand,name=diamond] run tp @s ~ ~ ~

# Build cannon platform 2
spreadplayers ~ ~-60 0 5 false @s
execute at @s run summon armor_stand ~ 205 ~ {Invisible:1,Marker:1,CustomName:"\"cannon2\"",CustomNameVisible:0}
execute at @e[type=armor_stand,name=cannon2] run function platforms:buildmagma
execute at @e[type=armor_stand,name=diamond] run tp @s ~ ~ ~

# Build team1 platform
spreadplayers ~ ~-30 0 5 false @s
execute at @s run summon armor_stand ~ 202 ~ {Invisible:1,Marker:1,CustomName:"\"team1\"",CustomNameVisible:0}
execute at @e[type=armor_stand,name=team1] run function platforms:buildteam1
execute at @e[type=armor_stand,name=diamond] run tp @s ~ ~ ~

# Build team2 platform
spreadplayers ~-30 ~15 0 5 false @s
execute at @s run summon armor_stand ~ 202 ~ {Invisible:1,Marker:1,CustomName:"\"team2\"",CustomNameVisible:0}
execute at @e[type=armor_stand,name=team2] run function platforms:buildteam2
execute at @e[type=armor_stand,name=diamond] run tp @s ~ ~ ~

# Build team3 platform
spreadplayers ~30 ~15 0 5 false @s
execute at @s run summon armor_stand ~ 202 ~ {Invisible:1,Marker:1,CustomName:"\"team3\"",CustomNameVisible:0}
