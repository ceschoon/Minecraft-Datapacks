...
spreadplayers ~20 ~ 0 5 false @s
execute at @s run summon armor_stand ~ 203 ~ {Invisible:1,Marker:1,CustomName:"\"emerald1\"",CustomNameVisible:0}
...
spreadplayers ~-20 ~ 0 5 false @s
execute at @s run summon armor_stand ~ 203 ~ {Invisible:1,Marker:1,CustomName:"\"villager1\"",CustomNameVisible:0}
...
execute at @s run summon armor_stand ~ 206 ~ {Invisible:1,Marker:1,CustomName:"\"cannon1\"",CustomNameVisible:0}
execute at @e[type=armor_stand,name=cannon1] run function platforms:buildmagma
execute at @e[type=armor_stand,name=diamond] run tp @s ~ ~ ~

# Build cannon platform 2
spreadplayers ~ ~-45 0 5 false @s
execute at @s run summon armor_stand ~ 206 ~ {Invisible:1,Marker:1,CustomName:"\"cannon2\"",CustomNameVisible:0}
