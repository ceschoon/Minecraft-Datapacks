...
execute store result score @a[team=ls_team2] X run data get entity @s Pos[0] 1
execute store result score @a[team=ls_team2] Y run data get entity @s Pos[1] 1
execute store result score @a[team=ls_team2] Z run data get entity @s Pos[2] 1
