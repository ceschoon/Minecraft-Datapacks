...
execute store result score @a[team=ls_team1] X run data get entity @s Pos[0] 1
execute store result score @a[team=ls_team1] Y run data get entity @s Pos[1] 1
execute store result score @a[team=ls_team1] Z run data get entity @s Pos[2] 1
