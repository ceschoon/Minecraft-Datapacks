...
execute if entity @s[team=team1] at @e[type=armor_stand,name=initteam1] run tp @s ~ ~ ~
execute if entity @s[team=team2] at @e[type=armor_stand,name=initteam2] run tp @s ~ ~ ~
