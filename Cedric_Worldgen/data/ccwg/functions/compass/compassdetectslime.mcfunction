...
execute if entity @p[scores={target=1},nbt={Dimension:"ccwg:slime"}] store result score @p[scores={target=1}] X run data get entity @p[scores={target=1}] Pos[0] 1
execute if entity @p[scores={target=1},nbt={Dimension:"ccwg:slime"}] store result score @p[scores={target=1}] Y run data get entity @p[scores={target=1}] Pos[1] 1
execute if entity @p[scores={target=1},nbt={Dimension:"ccwg:slime"}] store result score @p[scores={target=1}] Z run data get entity @p[scores={target=1}] Pos[2] 1
