...
execute if entity @s[scores={shot_genhouse2=2}] at @s run setblock ~ ~-2 ~ structure_block[mode=load]{author:"?",ignoreEntities:0b,integrity:1.0f,metadata:"",mirror:"NONE",mode:"LOAD",name:"shot:villager_house_2",posX:8,posY:-8,posZ:7,powered:0b,rotation:"CLOCKWISE_180",seed:0L,showair:0b,showboundingbox:0b}
...
execute if entity @s[scores={shot_genhouse3=2}] at @s run setblock ~ ~-2 ~ structure_block[mode=load]{author:"?",ignoreEntities:0b,integrity:1.0f,metadata:"",mirror:"NONE",mode:"LOAD",name:"shot:villager_house_3",posX:-9,posY:-7,posZ:-8,powered:0b,rotation:"NONE",seed:0L,showair:0b,showboundingbox:0b}
...
execute if entity @s[scores={shot_gentower1=2}] at @s run setblock ~ ~-2 ~ structure_block[mode=load]{author:"?",ignoreEntities:0b,integrity:1.0f,metadata:"",mirror:"NONE",mode:"LOAD",name:"shot:tower_platform",posX:-5,posY:-10,posZ:-5,powered:0b,rotation:"NONE",seed:0L,showair:0b,showboundingbox:0b}
...
execute if entity @s[scores={shot_gentower2=2}] at @s run setblock ~ ~-2 ~ structure_block[mode=load]{author:"?",ignoreEntities:0b,integrity:1.0f,metadata:"",mirror:"NONE",mode:"LOAD",name:"shot:tower_generator",posX:5,posY:-10,posZ:5,powered:0b,rotation:"CLOCKWISE_180",seed:0L,showair:0b,showboundingbox:0b}
...
####### actions if failed to generate within max number of trials
execute if entity @s[scores={shot_gentrials=1..}] run scoreboard players remove @s shot_gentrials 1
execute if entity @s[scores={shot_gentrials=0,shot_genmaster=1}] run tellraw @a {"text":"ShoT: Generation failed! Check if there is enough land around you with exposed grass and no big lakes","color":"gold"}
execute if entity @s[scores={shot_gentrials=0,shot_genmaster=1}] run scoreboard players set @s shot_genmaster 0
