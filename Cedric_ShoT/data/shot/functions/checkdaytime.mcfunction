...
execute as @r[scores={shot_LastCycle=0,shot_Daytime=1}] if entity @s[scores={shot_NumCycles=3..,shot_rng=0..4}] run scoreboard players set @a shot_LastCycle 2
execute as @r[scores={shot_LastCycle=0,shot_Daytime=12001}] if entity @s[scores={shot_NumCycles=3..,shot_rng=0..4}] run scoreboard players set @a shot_LastCycle 2
