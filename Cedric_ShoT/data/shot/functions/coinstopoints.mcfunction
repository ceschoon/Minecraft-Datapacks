...
execute at @e[type=armor_stand,name="village_centre"] as @a[team=farmers,distance=..2] store success score @s foh_AddScore run clear @s emerald{display:{Lore:["\"Coin\""]}} 1
execute at @e[type=armor_stand,name="village_centre"] as @a[team=hunters,distance=..2] store success score @s foh_AddScore run clear @s emerald{display:{Lore:["\"Coin\""]}} 1
