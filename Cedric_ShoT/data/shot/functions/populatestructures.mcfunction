...
execute if entity @a[scores={shot_genhouse2=2}] at @e[type=armor_stand,name=villager_house2] run summon villager ~ ~ ~ {VillagerData:{profession:armorer,level:5,type:savanna},NoAI:0,Invulnerable:1,Offers:{Recipes:[{buy:{id:emerald,Count:5,tag:{display:{Lore:["\"Coin\""]}}},sell:{id:raw_iron,Count:3},xp:1,maxUses:8},{buy:{id:emerald,Count:8,tag:{display:{Lore:["\"Coin\""]}}},sell:{id:coal,Count:4},xp:1,maxUses:4},{buy:{id:emerald,Count:16,tag:{display:{Lore:["\"Coin\""]}}},sell:{id:fire_charge,Count:1,tag:{display:{Lore:["\"Drop the fire charge to summon a fireball where you stand\""]}}},xp:1,maxUses:2}]}}
