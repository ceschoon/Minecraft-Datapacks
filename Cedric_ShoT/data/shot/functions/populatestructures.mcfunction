...
execute if entity @a[scores={shot_genhouse3=2}] at @e[type=armor_stand,name=villager_house3] run summon villager ~ ~ ~ {VillagerData:{profession:cleric,level:5,type:savanna},NoAI:0,Invulnerable:1,Offers:{Recipes:[{buy:{id:emerald,Count:2,tag:{display:{Lore:["\"Coin\""]}}},sell:{id:golden_apple,Count:1},xp:1,maxUses:4},{buy:{id:emerald,Count:12,tag:{display:{Lore:["\"Coin\""]}}},sell:{id:ender_pearl,Count:1},xp:1,maxUses:4},{buy:{id:emerald,Count:12,tag:{display:{Lore:["\"Coin\""]}}},sell:{id:chorus_fruit,Count:3},xp:1,maxUses:4},{buy:{id:emerald,Count:20,tag:{display:{Lore:["\"Coin\""]}}},sell:{id:potion,Count:1,tag:{Potion:"minecraft:invisibility"}},xp:1,maxUses:2},{buy:{id:emerald,Count:5,tag:{display:{Lore:["\"Coin\""]}}},sell:{id:potion,Count:1,tag:{Potion:"minecraft:strong_regeneration"}},xp:1,maxUses:2},{buy:{id:emerald,Count:12,tag:{display:{Lore:["\"Coin\""]}}},sell:{id:splash_potion,Count:1,tag:{Potion:"minecraft:poison"}},xp:1,maxUses:2}]}}
